	...
	tests := []struct {
	...
	}{
		{
			...
			payload: &mailinglistservice.UpdateGrpsioMailingListPayload{
				...
				Public:      boolPtr(true),
				ServiceUID:  stringPtr("svc-123"),
				Description: stringPtr("Valid description with enough characters"),
			},
			wantErr: false,
		},
		{
...
func TestValidateMailingListUpdateNewRules(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			payload: &mailinglistservice.UpdateGrpsioMailingListPayload{
				UID:         stringPtr("ml-123"),
				GroupName:   stringPtr("changed-group"),
		...
		},
		{
			...
			payload: &mailinglistservice.UpdateGrpsioMailingListPayload{
				UID:         stringPtr("ml-123"),
				GroupName:   stringPtr("main-group"),
		...
		},
		{
			...
			payload: &mailinglistservice.UpdateGrpsioMailingListPayload{
				...
				Public:      boolPtr(true),
				ServiceUID:  stringPtr("svc-123"),
				Description: stringPtr("Updated description with enough characters"),
			},
			wantErr: false,
		},
		{
