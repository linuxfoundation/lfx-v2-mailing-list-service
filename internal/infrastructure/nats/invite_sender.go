...
// NATSInviteSender implements port.InviteSender using NATS request/reply.
...
func (s *NATSInviteSender) SendInvite(ctx context.Context, req inviteapi.SendInviteRequest) (*model.InviteResult, error) {
...
var _ port.InviteSender = (*NATSInviteSender)(nil)
